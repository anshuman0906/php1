...
$query="update tbl_doctor set name='$name',fname='$fname',gender='$gender',contact='$mobile',fees='$fees',timing='$time',speciality='$spec',address='$address'where docid='$id'";
mysql_query($query);
