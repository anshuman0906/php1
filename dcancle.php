...
<div id="ab" style="background-image:url(images/s16.jpg);">
<div id="black">
<form><h1><u>Cancle Appointment</u></h1>
...
<td><a href="status.php?aid=<?php echo $row2['appid']; ?>"><?php echo $row2['status']; ?></a></td>
